...
export default function DashboardPage() {
  return (
    <UnifiedShell
      ...
      title="Developer AI Platform Dashboard"
      subtitle="One merged developer ai platform view for Projects, Agents, Prompts, Evaluations, Datasets, documents, audit, and AI."
    >
      ...
      <div className="grid columns-2">
        <div className="card stack">
          ...
          <div className="muted">
            This suite removes project-based navigation and groups shared developer ai platform jobs into one surface. Projects, Agents, Prompts, Evaluations, Datasets, Deployments, documents, audit, and AI are presented as platform features.</div>
