...
const seed: NotificationItem[] = [
  ...
  { id: 'note-2', title: 'Agents approval due', detail: 'Agents exception list needs approval.', read: false },
  { id: 'note-3', title: 'Prompts updated', detail: 'Prompts operating queue was refreshed.', read: true },
];
