export const AUTH_COOKIE = 'developer_ai_platform_suite_session';
...
export const demoUsers: DemoUser[] = [
  {
    email: 'admin@dev-ai-platform.local',
    password: 'admin123',
    firstName: 'Legal',
    lastName: 'Operator',
    role: 'admin',
  ...
  {
    email: 'manager@dev-ai-platform.local',
    password: 'manager123',
    firstName: 'Legal',
    lastName: 'Manager',
    role: 'manager',
  ...
  {
    email: 'analyst@dev-ai-platform.local',
    password: 'analyst123',
    firstName: 'Legal',
    lastName: 'Analyst',
    role: 'analyst',
