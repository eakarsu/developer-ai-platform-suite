...
const seedAudit: AuditEntry[] = [
  ...
  { id: 'audit-seed-2', at: '2026-05-24 09:10', area: 'Agents', action: 'Agents review assigned' },
  { id: 'audit-seed-3', at: '2026-05-24 11:40', area: 'Prompts', action: 'Prompts queue refreshed' },
];
