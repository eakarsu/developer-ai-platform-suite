...
const seed: DocumentRecord[] = [
  { id: 'doc-1', name: 'Projects Packet', type: 'Projects', owner: 'Platform Lead', status: 'In review', updatedAt: '2026-05-24 10:00' },
  { id: 'doc-2', name: 'Agents Review Bundle', type: 'Agents', owner: 'Operations Lead', status: 'Approval pending', updatedAt: '2026-05-24 11:20' },
  { id: 'doc-3', name: 'Prompts Evidence Set', type: 'Prompts', owner: 'Governance Lead', status: 'Ready', updatedAt: '2026-05-24 09:35' },
];
