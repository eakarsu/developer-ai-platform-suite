...
PORT="${PORT:-4210}"
DB_NAME="${PGDATABASE:-developer_ai_platform_suite}"
DB_HOST="${PGHOST:-127.0.0.1}"

echo "======================================="
echo "      Developer AI Platform Suite"
echo "======================================="
echo
...
echo "Starting developer ai platform suite frontend on http://localhost:$PORT"
echo "Login: admin@dev-ai-platform.local / admin123"
